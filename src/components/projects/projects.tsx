...
const Projects = () => {
  return ( 
    <div className="h-max pb-10 text-black bg-[#e9f2f6] rounded-t-lg">
      <div className="flex flex-col  items-center gap-5 mb-20">
        ...
        <div className="flex gap-4">
          <div className="w-[300px] border-t-2 max-md:w-[200px] border-[#636381] "></div>
          <div className="w-[300px] border-t-2 max-md:w-[200px] border-dashed border-[#636381] "></div>
        </div>
      </div>
      <div className="flex flex-col items-center gap-10 ">
        
        <div className="w-[70vw] h-[20rem]  p-5 flex items-center gap-3 bg-gradient-to-r from-[#ffffff] to-[#c1d3f7]  rounded-xl  shadow-md shadow-[#c0c1c6]">
        ...
        <div className="w-[70vw] h-[20rem]   p-5 flex items-center gap-3 bg-gradient-to-r from-[#ffffff] to-[#d5b4f4]  rounded-xl  shadow-md shadow-[#c0c1c6]">
        ...
        <div className="w-[70vw] h-[20rem]   p-5 px-10 flex items-center gap-10 bg-gradient-to-r from-[#ffffff] to-[#a3eeda]  rounded-xl  shadow-md shadow-[#c0c1c6]">
